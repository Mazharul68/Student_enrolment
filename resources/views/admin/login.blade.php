        ...
        <div class="row no-gutters">
            <div class="col-sm-6 align-self-center">
                <div class="sign-in-from">
                    ...
                    <form class="mt-4" method="POST" action="{{ route('login.admin') }}">
                        ...
                        @endif
                            <input type="password" name="password" name="{{ old('password') }}" class="form-control mb-0" id="exampleInputPassword1" placeholder="Enter Password">
                        </div>
            ...
            <div class="col-sm-6 text-center">
                <div class="sign-in-detail text-white" style="background: url({{ asset('public/admin') }}/images/login/2.jpg) no-repeat 0 0; background-size: cover;">
                    <a class="sign-in-logo mb-5" href="#"><img src="{{ asset('public/admin') }}/images/logo-white.png" class="img-fluid" alt="logo"></a>
